package com.pro.devgatedemo.utils
...
@Suppress("unused")
open class ZoomAbleImageView @JvmOverloads constructor(
    context: Context,
    ...
    private var otherTouchEnabled = false
    ...
    private var swipeImagesListner: swipeImagesListnerInt? = null
    ...
    interface swipeImagesListnerInt {
        fun onSwipeWhileMoving(img: ZoomAbleImageView, x: Int, y: Int, initX: Float, initY: Float)
    }
    ...
    fun otherTouchActivated(check: Boolean) {

        otherTouchEnabled = check
    }

    fun disableGesture(check: Boolean) {

        gestureDetector.setIsLongpressEnabled(check)
    }
            ...
            if (otherTouchEnabled) {
                ...
                when (event.action) {
                    ...
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        Log.d("initx", "onTouch: x" + initialX)
                        Log.d("initx", "onTouch: y" + initialY)
                        initialTouchX = event.rawX
                        initialTouchY = event.rawY
                    }

                    MotionEvent.ACTION_UP -> {
//                        this@Zoomable_Imageview.strokeColor = ColorStateList.valueOf(Color.TRANSPARENT)
//                        this@Zoomable_Imageview.strokeWidth = 0f
                        Log.d("initx", "onTouch: x" + initialX)
                        Log.d("initx", "onTouch: y" + initialY)
                        swipeImagesListner?.onSwipeWhileMoving(
                            this@ZoomAbleImageView,
                            this@ZoomAbleImageView.x.toInt(),
                            this@ZoomAbleImageView.y.toInt(),
                            initialX,
                            initialY
                        )
                        this@ZoomAbleImageView.x = initialX
                        this@ZoomAbleImageView.y = initialY
                        this@ZoomAbleImageView.z = 0f
//                        CollageConstants.disableOtherLongClick = false
                        this@ZoomAbleImageView.otherTouchActivated(false)
                    }
    ...
    open fun setImgMoveLeaveListner(onImgLeaveListner: swipeImagesListnerInt): ZoomAbleImageView {
